			...
			<div id="contents">
				<div id="customer">
					...
					<div class="viewDivMt">
						...
						<div class="viewContents">
							<img src="/upload/board/${bdto.bfile}" width = "630px">
						</div>
						</c:if>
					</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								<tr>
									...
									<c:if test="${prev_bdto.bno != null}">
									<td><a href="/customer/nview?bno=${prev_bdto.bno}">${prev_bdto.btitle}</a></td>
									</c:if>
									<c:if test="${prev_bdto.bno == null}">
									<td>이전 게시물이 없습니다.</td>
									</c:if>
								...
								<tr>
									...
									<c:if test="${next_bdto != null}">
									<td><a href="/customer/nview?bno=${next_bdto.bno}">${next_bdto.btitle}</a></td>
									</c:if>
									<c:if test="${next_bdto == null}">
									<td>다음 게시물이 없습니다.</td>
									</c:if>
