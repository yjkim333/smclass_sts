...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="customer">
					<h2><strong>회원 LIST</strong><span>쟈뎅샵 소식을 전해드립니다.</span></h2>
					...
					<div class="orderDivMt">
						<table summary="NO, 제목, 등록일, 조회수 순으로 공지사항을 조회 하실수 있습니다." class="orderTable2" border="1" cellspacing="0">
							...
							<fmt:formatDate var="day" value="${mdto.mdate}" pattern="yyyy-MM-dd"/>
								<tr>
									<td class="tnone">${mdto.id}</td>
									<td class="left">
										<a href="/customer/nview?bno=${mdto.id}">${mdto.name}</a>
										<img src="../images/ico/ico_new.gif" alt="NEW" />
									</td>
									<td class="tnone right">${mdto.phone}</td>
									<td class="tnone right">${mdto.gender}</td>
									<td><fmt:formatDate value="${mdto.mdate}" pattern="yyyy-MM-dd"/></td>
								</tr>
							</c:forEach>
							</tbody>
						</table>
