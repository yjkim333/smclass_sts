				...
				<div id="mypage">
					...
					<div class="eventList">
						<ul>
							...
							<li>
								<div class="img">
									<a href="/event/eview?eno=${event.eno}"><img src="/upload/board/${event.efile}" alt="진행중 이벤트" /></a>
								</div>
								<div class="txt">
									<div class="subject">${event.etitle}</div>
									<div class="day">이벤트 기간 : <fmt:formatDate value="${event.stdate}" pattern="yyyy-MM-dd"/> ~ <fmt:formatDate value="${event.enddate}" pattern="yyyy-MM-dd"/></div>
								</div>
							</li>
							</c:forEach>
						</ul>
					...
					<div class="btnArea">
						<div class="bCenter">
							<ul>																
								<li><a href="/event/eventWrite" class="sbtnMini">등록</a></li>
							</ul>
						</div>
					</div>
					<!-- //Btn Area -->
