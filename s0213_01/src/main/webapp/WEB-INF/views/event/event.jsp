				...
				<div id="mypage">
					...
					<div class="eventList">
						<ul>
							...
							<li>
								<div class="img">
									<a href="/event/event_view?eno=${edto.eno}"><img src="/upload/board/${edto.efile}" alt="진행중 이벤트" /></a>
								</div>
								<div class="txt">
									<div class="subject">${edto.etitle}</div>
									<div class="day">이벤트 기간 : <fmt:formatDate value="${edto.stdate}" pattern="yyyy-MM-dd"/> ~ <fmt:formatDate value="${edto.enddate}" pattern="yyyy-MM-dd"/></div>
								</div>
							</li>
							</c:forEach>
						</ul>
